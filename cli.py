"""
Command Line Interface for Rowhammer Dram Mitigation Agent.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="rowhammer-dram-mitigation-agent", description="Rowhammer Dram Mitigation Agent")
    ...
    if args.command == "audit":
        ...
        print("=" * 80)
        print(f"  ROWHAMMER DRAM MITIGATION AGENT")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Rowhammer Dram Mitigation Agent Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Rowhammer Dram Mitigation Agent API server on http://{args.host}:{args.port}")
