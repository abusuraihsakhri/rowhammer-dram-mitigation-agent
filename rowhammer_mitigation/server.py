"""
FastAPI REST API Server for Rowhammer DRAM Bit-Flip Vulnerability & TRR Mitigation Agent.
"""
...
def create_app():
    try:
        ...
        app = FastAPI(
            title="Rowhammer DRAM Bit-Flip Vulnerability & TRR Mitigation Agent",
            description="Simulates double-sided rowhammer activation patterns, bit-flip blast radiuses, and validates Target Row Refresh (TRR) policies.",
        ...
        @app.get("/health")
        def health():
            return {"status": "HEALTHY", "system": "rowhammer-dram-mitigation-agent", "domain": "Hardware Security", "version": "2.0.0-FRONTIER"}
