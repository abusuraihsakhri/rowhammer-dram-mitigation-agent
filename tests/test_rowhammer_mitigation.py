...
import pytest
from rowhammer_mitigation.models import FrontierPayload, ExecutionStatus
from rowhammer_mitigation.engine import FrontierDomainEngine
from rowhammer_mitigation.agents import AggressorRowPatternAgent, BitFlipBlastRadiusAgent, TRRMitigationEvaluatorAgent, RowhammerCoordinator
from rowhammer_mitigation.cli import main


def test_sub_agents():
    a1 = AggressorRowPatternAgent()
    ...
    a3 = TRRMitigationEvaluatorAgent()
...
def test_coordinator():
    ...
    assert "JEDEC DRAM Security Guidelines" in ans or "specifications" in ans
